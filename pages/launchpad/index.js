...
const Launchpad = () => {
  ...
  return (
    <div className='container mx-auto px-5 sm:px-24 lg:px-48'>
      <div className='flex flex-col lg:justify-between border border-pink-900 bg-purple-700/10 rounded-md p-8 lg:p-12 xl:flex-row gap-5 min-h-24 text-white w-full mt-12'>
        <div className='flex-1 '>
          ...
          <div className='mt-12 w-full xl:pr-16'>
            ...
            <div className='w-full flex h-5 bg-purple-700 my-3 rounded-full relative overflow-hidden'>
              <div
      ...
      <div className='container py-5 mx-auto mt-12'>
        ...
        <div className='flex mt-5 px-2 gap-5 w-full overflow-auto styled-scrollbar py-4 scrollbar-thumb-purple-600'>
