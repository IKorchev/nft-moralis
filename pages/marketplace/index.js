      ...
      <div className='relative z-10 flex items-baseline justify-between pt-24 pb-2 border-b border-gray-200'>
        ...
        <div className='flex items-center'>
          <Menu as='div' className='relative inline-block text-left'>
            <Menu.Button className='group inline-flex justify-center  font-medium bg-primary-500 px-3 py-2 rounded-lg text-white hover:text-white'>
              Sort
              <ChevronDownIcon
            ...
            <Transition
              ...
              <Menu.Items className='origin-top-right absolute right-0 mt-2 w-52 rounded-md shadow-2xl bg-primary-900 ring-1 ring-black ring-opacity-5 focus:outline-none'>
                <div className='py-1'>
