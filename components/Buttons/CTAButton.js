...
export const Primary = (props) => {
  return (
    <a
      {...props}
      className='mx-2 w-max cursor-pointer rounded border border-cyan-600 bg-gradient-to-tr from-emerald-200 to-cyan-300 px-5 py-2.5 text-base 
...
export const Secondary = (props) => {
  return (
    <a
      {...props}
      className='mx-2 w-max cursor-pointer rounded border border-cyan-400 bg-transparent px-5 py-2.5 
