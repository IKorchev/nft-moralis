    ...
    <Dialog
      ...
      <Dialog.Description className='max-w-96'>
        <motion.div className='border-secondary-600 bg-primary-900 shadow-glass-large z-20 grid place-items-center rounded-lg border p-5  px-24 backdrop-blur-sm backdrop-filter'>
          ...
          <form className='mt-5 flex flex-col text-white'>
          ...
          <div
            ...
            `}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non quaerat eaque,
            architecto consectetur laborum vero atque placeat culpa modi.
          </div>
        </motion.div>
      </Dialog.Description>
    </Dialog>
