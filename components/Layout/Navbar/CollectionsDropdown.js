  ...
  return (
    <Menu as='div' className='relative z-50 inline-block text-left'>
      ...
      <Menu.Items
        ...
        className='absolute right-0 z-50 w-48 origin-top transform divide-y divide-secondary-700
        ...
        <Menu.Item as='li'>
          {({ active }) => (
            <Link href='/collections'>
              <a className={`${active ? "bg-secondary-500 text-white" : " "}  flex w-full px-2 py-2`}>
